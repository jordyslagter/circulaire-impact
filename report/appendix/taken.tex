...
\section{Taak 9}
Het idee van producten als een service houdt in dat een product zoals lampen of een koelkast verkocht worden als een service.
Dit houdt in dat een consument deze producten niet zelf bezit maar een vast bedrag betaalt om gebruik te maken van een (werkend) product.
Doordat de producent verantwoordelijk is om ervoor te zorgen dan een consument altijd een werkend product heeft is het gunstig om deze producten efficiënt en met een lange levensduur te produceren.
Verder zorgt dit ook ervoor dat producenten verantwoordelijk zijn voor het product op het einde van de levensduur, 
waardoor het gunstig is voor de producent om ervoor te zorgen dat het gemakkelijk recyclebaar of opnieuw inzetbaar is.
\newline{}
Verder kan een product bieden als een service helpen voor mensen met een kleine portemonnee om alsnog duurdere maar ook efficiëntere apparaten te verkrijgen.
\newline{}
Een oplossing die geboden wordt om het recyclen van producten gemakkelijker te maken is om ieder product een 'materiaalpaspoort' te geven.
In dit paspoort staat exact welke materialen in welke hoeveelheden in het product verwerkt zijn.
